        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('search') }}">
                        <div class="text-xl font-bold text-orange-600">🌡️ AtsuSearch</div>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="bg-blue-500 text-white hover:bg-blue-600 px-4 py-2 rounded-md text-sm font-medium">
                            新規登録
                        </a>
                    </div>
                @endauth
